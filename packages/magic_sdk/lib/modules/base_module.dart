...
class BaseModule {
  ...
  Future<JavascriptMessage> sendToProvider({required String method, List<dynamic>? params}) async {

    MagicRPCRequest request = MagicRPCRequest(method: method, params: params ?? []);
